                ...
                <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-2 sm:gap-3">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 bg-yellow-400 rounded-lg flex items-center justify-center flex-shrink-0">
                            <span className="text-black font-bold text-lg sm:text-xl">SI</span>
                        </div>
                    ...
                    <div className="flex items-center gap-2 sm:gap-4">
                        <NavigationControls
                            ...
                            allowedPathPrefix="/student"
                        />
                        <span className="text-xs sm:text-sm text-muted-foreground hidden md:inline-block truncate max-w-[150px] lg:max-w-none">
                            {session.user.email}
                        </span>
                        <form action={async () => {
                            'use server';
