...
const DEFAULT_PROGRAMS: ProgramsContent = {
    ...
    categories: [
        ...
        },
        {
            ...
            slug: 'pelatihan-motivasi-manager-bisnis',
    ...
    items: [
        ...
        // PELATIHAN MOTIVASI - Service Excellent
        {
            ...
            slug: 'service-excellent-from-heart',
            ...
            ctaButtonLink: '/program/pelatihan-motivasi-manager-bisnis/service-excellent-from-heart',
            ctaButtonLinkDetail: '#',
            order: 1,
            metadata: {
                duration: '2-3 Hari',
        ...
        // PELATIHAN MOTIVASI - Communication Excellent
        {
            ...
            slug: 'communication-excellent-from-heart',
            ...
            ctaButtonText: DEFAULT_CTA.card,
            ctaButtonTextDetail: 'Daftar Pelatihan →',
            ctaButtonLink: '/program/pelatihan-motivasi-manager-bisnis/communication-excellent-from-heart',
            ctaButtonLinkDetail: '#',
            order: 2,
            metadata: {
                duration: '2-3 Hari',
        ...
        // PELATIHAN MOTIVASI - Leadership Excellent
        {
            ...
            slug: 'leadership-excellent-from-heart',
            ...
            ctaButtonText: DEFAULT_CTA.card,
            ctaButtonTextDetail: 'Daftar Pelatihan →',
            ctaButtonLink: '/program/pelatihan-motivasi-manager-bisnis/leadership-excellent-from-heart',
            ctaButtonLinkDetail: '#',
            order: 3,
            metadata: {
                duration: '2-3 Hari',
